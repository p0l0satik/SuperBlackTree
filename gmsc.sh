cd test_0
mpicc -std=gnu99 mpi_mal16.c -o test0size16
...
mpicc -std=gnu99 mpi_mal32.c -o test0size32
...
mpicc -std=gnu99 mpi_mal64.c -o test0size64
...
mpicc -std=gnu99 mpi_mal128.c -o test0size128
...
mpicc -std=gnu99 mpi_mal256.c -o test0size256
...
mpicc -std=gnu99 mpi_mal512.c -o test0size512
...
mpicc -std=gnu99 mpi_mal600.c -o test0size600
